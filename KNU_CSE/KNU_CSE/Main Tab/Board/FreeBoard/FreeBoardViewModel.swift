...
struct FreeBoardViewModel{
    ...
    mutating func setUpBoards(){
        ...
        boards.append(Board(boardId: 1, category: 0, title: "테스트 게시판8", content: "테스트 게시판8", author: "노준석", date: "2021 07.24 23:17",numberOfcomment: 1))
        boards.append(Board(boardId: 1, category: 0, title: "테스트 게시판9", content: "테스트 게시판9", author: "노준석", date: "2021 07.24 23:17",numberOfcomment: 1))
        boards.append(Board(boardId: 1, category: 0, title: "테스트 게시판10", content: "테스트 게시판10", author: "노준석", date: "2021 07.24 23:17",numberOfcomment: 1))
        boards.append(Board(boardId: 1, category: 0, title: "테스트 게시판11", content: "테스트 게시판11", author: "노준석", date: "2021 07.24 23:17",numberOfcomment: 1))
        boards.append(Board(boardId: 1, category: 0, title: "테스트 게시판12", content: "테스트 게시판12", author: "노준석", date: "2021 07.24 23:17",numberOfcomment: 1))
        boards.append(Board(boardId: 1, category: 0, title: "테스트 게시판13", content: "테스트 게시판13", author: "노준석", date: "2021 07.24 23:17",numberOfcomment: 1))
        boards.append(Board(boardId: 1, category: 0, title: "테스트 게시판14", content: "테스트 게시판14", author: "노준석", date: "2021 07.24 23:17",numberOfcomment: 1))
        boards.append(Board(boardId: 1, category: 0, title: "테스트 게시판15", content: "테스트 게시판15", author: "노준석", date: "2021 07.24 23:17",numberOfcomment: 1))
        boards.append(Board(boardId: 1, category: 0, title: "테스트 게시판16", content: "테스트 게시판16", author: "노준석", date: "2021 07.24 23:17",numberOfcomment: 1))
    }
}
